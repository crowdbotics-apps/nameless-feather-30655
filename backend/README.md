...
## Project Structure
    ...
    ├── nameless_feather_30655  # Django project configurations
...
1. Clone this repo and `cd nameless_feather_30655`
...
2. Clone this repo and `cd nameless_feather_30655`
